...
class YOLONanoService:
    ...
    def __init__(self, model_path=None, config_path=None):
        ...
        if model_path is None:
            model_path = Path(__file__).parent.parent.parent / 'Ai' / 'yolo-nano' / 'runs' / 'train' / 'exp' / 'best.pt'
        if config_path is None:
            config_path = Path(__file__).parent.parent.parent / 'Ai' / 'yolo-nano' / 'configs' / 'yolo_nano.yaml'
    ...
    def load_model(self, model_path, config_path):
        ...
        try:
            ...
            if Path(model_path).exists():
                ...
                print("Please train the model first using: python train.py --epochs 100")
