...
def setup_custom_model():
    ...
    dataset_yaml = (
        r"c:\Users\boume\Briefs\Filrouge2A\Ai\data\custom_dataset\dataset.yaml"
    )
...
def main():
    ...
    test_image = (
        r"c:\Users\boume\Briefs\Filrouge2A\images\product_1_Ceramic Vase\image_1.jpg"
    )
    ...
    if success:
        ...
        print(
            "📊 Dataset config: c:\\Users\\boume\\Briefs\\Filrouge2A\\Ai\\data\\custom_dataset\\dataset.yaml"
        )
